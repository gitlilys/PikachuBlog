	...
	<body>
		<div class="container-fluid" id="body">
			...
			<div class="row" id="logo">
				...
				<div> 
						<br><br>
						<a href="JSP/user/userSuccessLogin.jsp"><span class="glyphicon glyphicon-user"></span> 用户${NOWUSER.user_name}		
						<a href="${pageContext.request.contextPath}/blog/logout"><span class="glyphicon glyphicon-user"></span> 退出登录		
				</div>
			</div>
